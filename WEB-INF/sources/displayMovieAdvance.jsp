...
<html>
	...
	<body>
		...
		<form ACTION="/fabflix/goAdvanceSearch"><input type="SUBMIT" value="title" name = "order">	
		<form ACTION="/fabflix/goAdvanceSearch"><input type="SUBMIT" value="year" name = "order">	


		<form ACTION = "/fabflix/goAdvanceSearch" METHOD = "GET"> 
...
//		document.getElementById("prevbutton").disabled = true;
		...
		<%
			List<Movie> mlist =  (List<Movie>)session.getAttribute("searchResult3");
			if(mlist == null) {
		...
		<%
			...
			session.setAttribute("searchResult3",null);
		%>
